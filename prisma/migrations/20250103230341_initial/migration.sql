...
CREATE TABLE "ThesisKeyword" (
    ...
    CONSTRAINT "ThesisKeyword_pkey" PRIMARY KEY ("thesis_no","keyword_name")
);
...
-- AddForeignKey
ALTER TABLE "ThesisKeyword" ADD CONSTRAINT "ThesisKeyword_keyword_name_fkey" FOREIGN KEY ("keyword_name") REFERENCES "Keyword"("name") ON DELETE RESTRICT ON UPDATE CASCADE;
